...
from menfess import dbclone, set_main_bot
...
class Dk(Client):
    ...
    async def start(self) -> tuple[bool, Client]:
        ...
        await self.set_bot_commands([
            ...
            BotCommand('talent', '👙 talent konten / vcs'), BotCommand('daddysugar', '👔 daddy sugar trusted'),
            BotCommand('proplayer', '🎮 pro player'), BotCommand('temancurhat', '🤗 teman curhat'),
            BotCommand('gfrent', '🤵 girl friend rent'), BotCommand('bfrent', '🤵 boy friend rent')
